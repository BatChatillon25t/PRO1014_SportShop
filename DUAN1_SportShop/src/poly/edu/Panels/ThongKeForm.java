...
//        System.out.println(df.format(number));
        ...
        for (thongKe ke : tke) {
//            dataset.setValue(ke.getDoanhThu(), "Số tiền", String.valueOf(ke.getThang()));
            BigDecimal doanhThu = new BigDecimal(String.valueOf(ke.getDoanhThu()));
            dataset.setValue(Double.parseDouble(doanhThu.toPlainString()), "Số tiền", String.valueOf(ke.getThang()));
